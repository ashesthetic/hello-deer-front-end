			...
			<div className="App">
				<Routes>
					...
					<Route
						...
						element={isAuthenticated ? <Layout><ProtectedRoute requiredPermission="notStaff"><PayrollDetailPage /></ProtectedRoute></Layout> : <Navigate to="/login" />}
					/>
					<Route
