	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			const submitData = {
				...
				premium_price: parseFloat(formData.premium_price) || 0,
				diesel_price: parseFloat(formData.diesel_price) || 0,
			};
			...
			<form onSubmit={handleSubmit} className="mt-8 space-y-8">
				...
				<div className="bg-white shadow rounded-lg p-6">
					...
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
						...
						<div>
							<label htmlFor="premium_price" className="block text-sm font-medium text-gray-700">
								Price
							</label>
							<input
								type="number"
				...
				<div className="bg-white shadow rounded-lg p-6">
					...
					<div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
						...
						<div>
							<label htmlFor="diesel_price" className="block text-sm font-medium text-gray-700">
								Price
							</label>
							<input
								type="number"
								...
								onChange={(e) => handleInputChange('diesel_price', e.target.value)}
								className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
								placeholder="0.000"
							/>
						</div>
