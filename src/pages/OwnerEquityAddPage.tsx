...
import { CreateOwnerEquityData, Owner } from '../types';
import { canCreate } from '../utils/permissions';
import { usePageTitle } from '../hooks/usePageTitle';
import { getTodayForInput } from '../utils/dateUtils';

const OwnerEquityAddPage: React.FC = () => {
  usePageTitle('Add Equity Transaction');
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">You don't have permission to create equity transactions.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Add Equity Transaction</h1>
          <button
...
export default OwnerEquityAddPage; 